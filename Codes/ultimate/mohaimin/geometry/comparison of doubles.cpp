1. bool equalTo ( double a, double b ){ if ( fabs ( a - b ) <= eps ) return true; else return false; }
2. bool notEqual ( double a, double b ){if ( fabs ( a - b ) > eps ) return true; else return false; }
